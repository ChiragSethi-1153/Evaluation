...
import { createQuestions } from '../../features/Questions/questionAction';

const AddQuestions = ({ hide, testId }) => {


    const [inputs, setInputs] = useState({testId: testId, question: '', option1: '', option2: '', option3: '', option4: '', correctOption: '', marks: null})
    const dispatch = useDispatch()
    const handleSubmit = (e) => {
        e.preventDefault()
        dispatch(createQuestions(inputs))
        hide()
    }
  ...
  return (  
    <Box>
        ...
        />
    <Paper className={styles.addQuestionform} >
